...
func (c *InstanceCacher) onServiceEvent(evt K8sEvent) { _ = "STUB: not implemented"; return }
...
func (c *InstanceCacher) onEndpointsEvent(evt K8sEvent) { _ = "STUB: not implemented"; return }
